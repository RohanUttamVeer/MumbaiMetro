...
public class Main8Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Return Journey");
        // Views
        textResult = (TextView) findViewById(R.id.res1);
        spinnerSource = (Spinner) findViewById(R.id.spinne_source1);
        spinnerDestination = (Spinner) findViewById(R.id.spinner_destination1);
